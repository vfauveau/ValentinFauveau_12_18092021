    ...
    return (
        <div className="content-main">
            <header className="content-header">
                <h1 className="content-header-welcome">Bienvenue</h1>
            ...
            <div className="content-charts-wrapper">
                ...
                <div className="content-data-indicator-column">
                    <DataIndicator icon={fireIcon} iconSize={"20px"} color={"rgb(255, 0, 0, 0.07)"}/>
                    <DataIndicator icon={proteinesIcon} iconSize={"20px"} color={"#4AB8FF1A"}/>
                    <DataIndicator icon={appleIcon} iconSize={"20px"} color={"rgb(249, 206, 35, 0.2)"}/>
                    <DataIndicator icon={cheeseburgerIcon} iconSize={"20px"} color={"#FD51811A"}/>
                </div>
            </div>
        </div>
    );
