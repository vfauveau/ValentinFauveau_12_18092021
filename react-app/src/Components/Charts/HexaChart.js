...
const HexaChart = (props) => {
    ...
    return (
        <ResponsiveContainer width="100%" height="100%">
            <RadarChart width={130} height={130} style={{ backgroundColor: "#282D30" }} cx="50%" cy="50%" outerRadius="60%" data={data}>
                <PolarGrid stroke={"white"} />
                <PolarAngleAxis tickCount={4} tickLine={false} dataKey="kind" fontSize={"11px"} stroke="white" />
